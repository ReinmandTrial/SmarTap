(() => {
            ...
            function initSpollerBody(spollersBlock, hideSpollerBody = true) {
                ...
                if (spollerItems.length) spollerItems.forEach(((spollerItem, index) => {
                    ...
                    if (hideSpollerBody) {
                        ...
                        if (index === 0) {
                            spollerItem.setAttribute("data-open", "true");
    ...
    function initializeVideoControls() {
        ...
        videoContainers.forEach((container => {
            const video = container.querySelector(".video-container__video");
            const playButton = container.querySelector(".video-container__control");
            playButton.addEventListener("click", (() => {
                if (video.paused) {
                    video.play();
                    playButton.classList.add("hidden");
                    container.classList.remove("video-pause");
                    container.classList.add("video-play");
                } else {
                    video.pause();
                    playButton.classList.remove("hidden");
                    container.classList.remove("video-play");
                    container.classList.add("video-pause");
                }
            }));
    ...
    document.querySelectorAll(".card-address").forEach((details => {
        details.addEventListener("toggle", (event => {
            if (event.target.open) {
                const address = details.getAttribute("data-address");
    ...
    window.addEventListener("DOMContentLoaded", (() => {
        const firstDetails = document.querySelector(".card-address");
        if (firstDetails) {
            const address = firstDetails.getAttribute("data-address");
            const iframe = document.getElementById("map");
            iframe.style.opacity = 0;
            iframe.addEventListener("load", (() => {
                iframe.style.opacity = 1;
